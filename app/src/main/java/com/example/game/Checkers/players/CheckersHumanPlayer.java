...
public class CheckersHumanPlayer extends GameHumanPlayer {
    ...
    //TODO in this file every place where checkers list sets something needs to be game.sendAction(new checkersAction)
    ...
    public CheckersHumanPlayer(String name, int ID) {
        super(name);
        layoutId = ID;
    }
        ...
        for(int r = 0; r < imageButtonList.length; r++) {
            for (int c = 0; c < imageButtonList[r].length; c++) {
                if (imageButtonList[r][c] != null) {//if the imageButton is not null
                    ...
                    imageButtonList[r][c].setBackgroundColor(activity.getResources().getColor(R.color.checker_tan));//set the desirable background color
                }
            }
        }
    }
    ...
    private void initializeBoard() {
        ...
        //row 1
        ibtn_0_0 = (ImageButton) activity.findViewById(R.id.ibtn_0_0);
        ibtn_0_1 = (ImageButton) activity.findViewById(R.id.ibtn_0_1);
        ibtn_0_2 = (ImageButton) activity.findViewById(R.id.ibtn_0_2);
        ibtn_0_3 = (ImageButton) activity.findViewById(R.id.ibtn_0_3);
        ibtn_0_4 = (ImageButton) activity.findViewById(R.id.ibtn_0_4);
        ibtn_0_5 = (ImageButton) activity.findViewById(R.id.ibtn_0_5);
        ibtn_0_6 = (ImageButton) activity.findViewById(R.id.ibtn_0_6);
        ibtn_0_7 = (ImageButton) activity.findViewById(R.id.ibtn_0_7);

        //row 2
        ibtn_1_0 = (ImageButton) activity.findViewById(R.id.ibtn_1_0);
        ibtn_1_1 = (ImageButton) activity.findViewById(R.id.ibtn_1_1);
        ibtn_1_2 = (ImageButton) activity.findViewById(R.id.ibtn_1_2);
        ibtn_1_3 = (ImageButton) activity.findViewById(R.id.ibtn_1_3);
        ibtn_1_4 = (ImageButton) activity.findViewById(R.id.ibtn_1_4);
        ibtn_1_5 = (ImageButton) activity.findViewById(R.id.ibtn_1_5);
        ibtn_1_6 = (ImageButton) activity.findViewById(R.id.ibtn_1_6);
        ibtn_1_7 = (ImageButton) activity.findViewById(R.id.ibtn_1_7);

        //row 3
        ibtn_2_0 = (ImageButton) activity.findViewById(R.id.ibtn_2_0);
        ibtn_2_1 = (ImageButton) activity.findViewById(R.id.ibtn_2_1);
        ibtn_2_2 = (ImageButton) activity.findViewById(R.id.ibtn_2_2);
        ibtn_2_3 = (ImageButton) activity.findViewById(R.id.ibtn_2_3);
        ibtn_2_4 = (ImageButton) activity.findViewById(R.id.ibtn_2_4);
        ibtn_2_5 = (ImageButton) activity.findViewById(R.id.ibtn_2_5);
        ibtn_2_6 = (ImageButton) activity.findViewById(R.id.ibtn_2_6);
        ibtn_2_7 = (ImageButton) activity.findViewById(R.id.ibtn_2_7);

        //row 4
        ibtn_3_0 = (ImageButton) activity.findViewById(R.id.ibtn_3_0);
        ibtn_3_1 = (ImageButton) activity.findViewById(R.id.ibtn_3_1);
        ibtn_3_2 = (ImageButton) activity.findViewById(R.id.ibtn_3_2);
        ibtn_3_3 = (ImageButton) activity.findViewById(R.id.ibtn_3_3);
        ibtn_3_4 = (ImageButton) activity.findViewById(R.id.ibtn_3_4);
        ibtn_3_5 = (ImageButton) activity.findViewById(R.id.ibtn_3_5);
        ibtn_3_6 = (ImageButton) activity.findViewById(R.id.ibtn_3_6);
        ibtn_3_7 = (ImageButton) activity.findViewById(R.id.ibtn_3_7);

        //row 5
        ibtn_4_0 = (ImageButton) activity.findViewById(R.id.ibtn_4_0);
        ibtn_4_1 = (ImageButton) activity.findViewById(R.id.ibtn_4_1);
        ibtn_4_2 = (ImageButton) activity.findViewById(R.id.ibtn_4_2);
        ibtn_4_3 = (ImageButton) activity.findViewById(R.id.ibtn_4_3);
        ibtn_4_4 = (ImageButton) activity.findViewById(R.id.ibtn_4_4);
        ibtn_4_5 = (ImageButton) activity.findViewById(R.id.ibtn_4_5);
        ibtn_4_6 = (ImageButton) activity.findViewById(R.id.ibtn_4_6);
        ibtn_4_7 = (ImageButton) activity.findViewById(R.id.ibtn_4_7);

        //row 6
        ibtn_5_0 = (ImageButton) activity.findViewById(R.id.ibtn_5_0);
        ibtn_5_1 = (ImageButton) activity.findViewById(R.id.ibtn_5_1);
        ibtn_5_2 = (ImageButton) activity.findViewById(R.id.ibtn_5_2);
        ibtn_5_3 = (ImageButton) activity.findViewById(R.id.ibtn_5_3);
        ibtn_5_4 = (ImageButton) activity.findViewById(R.id.ibtn_5_4);
        ibtn_5_5 = (ImageButton) activity.findViewById(R.id.ibtn_5_5);
        ibtn_5_6 = (ImageButton) activity.findViewById(R.id.ibtn_5_6);
        ibtn_5_7 = (ImageButton) activity.findViewById(R.id.ibtn_5_7);

        //row 7
        ibtn_6_0 = (ImageButton) activity.findViewById(R.id.ibtn_6_0);
        ibtn_6_1 = (ImageButton) activity.findViewById(R.id.ibtn_6_1);
        ibtn_6_2 = (ImageButton) activity.findViewById(R.id.ibtn_6_2);
        ibtn_6_3 = (ImageButton) activity.findViewById(R.id.ibtn_6_3);
        ibtn_6_4 = (ImageButton) activity.findViewById(R.id.ibtn_6_4);
        ibtn_6_5 = (ImageButton) activity.findViewById(R.id.ibtn_6_5);
        ibtn_6_6 = (ImageButton) activity.findViewById(R.id.ibtn_6_6);
        ibtn_6_7 = (ImageButton) activity.findViewById(R.id.ibtn_6_7);

        //row 8
        ibtn_7_0 = (ImageButton) activity.findViewById(R.id.ibtn_7_0);
        ibtn_7_1 = (ImageButton) activity.findViewById(R.id.ibtn_7_1);
        ibtn_7_2 = (ImageButton) activity.findViewById(R.id.ibtn_7_2);
        ibtn_7_3 = (ImageButton) activity.findViewById(R.id.ibtn_7_3);
        ibtn_7_4 = (ImageButton) activity.findViewById(R.id.ibtn_7_4);
        ibtn_7_5 = (ImageButton) activity.findViewById(R.id.ibtn_7_5);
        ibtn_7_6 = (ImageButton) activity.findViewById(R.id.ibtn_7_6);
        ibtn_7_7 = (ImageButton) activity.findViewById(R.id.ibtn_7_7);

package com.example.checkers.alpha.offline.GameFramework.info;

import static com.example.checkers.alpha.offline.GameFramework.util.Saving.SEPARATOR;
...
public abstract class GameState extends GameInfo {
  ...
  //How many setup phases we have, initially set to 0
     ...
     */
   public String toString(){ return numSetupTurns + SEPARATOR + currentSetupTurn; }
}
